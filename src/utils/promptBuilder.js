 ...
 * Contains the full tool list, the task reference, and the blocker-question pattern.
 * The caller is responsible for appending buildCommentGuidanceLines() if note/handoff
 ...
 *
 * Untracked files (??) are filtered out — they are irrelevant to pipeline
 * agents and can be misleading when a project has many generated artefacts.
 *
