...
mcp__prism__kanban_add_comment({ spaceId: SPACE_ID, taskId: TASK_ID, author: "code-reviewer", type: "note", text: "Assumption: <what you assumed and why it is not explicit in the spec>" })
