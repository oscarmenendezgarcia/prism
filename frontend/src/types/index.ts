...
export interface Space {
  ...
  /** QOL-2: true when the space is pinned in SpaceTabs (always visible, never in overflow). */
  pinned?: boolean;
  /** QOL-2: zero-based position within the pinned zone. Absent for non-pinned spaces. */
  pinnedRank?: number;
  createdAt: string;
  updatedAt: string;
}
